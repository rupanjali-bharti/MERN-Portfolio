  ...
  return (
    ...
    >
      <div className="container mx-auto px-6">
        <h2 className='text-3xl font-bold text-center mb-4'> My <span className='text-purple'>Experience</span></h2>
        <p className='text-gray-400 text-center max-w-2xl mx-auto pb-5'>My professional Journey so far</p>
              ...
              workData.map((data, index)=> (
                ...
                ">
                  ...
                  <div className='bg-dark-300 rounded-2xl p-6'>
                    ...
                    <p className='text-gray-400 mb-2 text-sm'>{data.company}</p>
